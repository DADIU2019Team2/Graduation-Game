...
public class WaypointManagerWindow : EditorWindow
{
    ...
    void CreateWaypoint()
    {
        ...
        if(waypointRoot.childCount > 1)
        {
            ...
            //Debug.Log(waypointRoot.GetChild(waypointRoot.childCount - 2).GetComponent<Waypoint>().gameObject.name);
            waypoint.previousWaypoint.nextWaypoint = waypoint;

            //place the waypoint in the same position as previous waypoint
