...
public class Machine2Sound : MonoBehaviour
{
  ...
  // This makes the sound play (loops)
    void Start()
    {
        ...
        AkSoundEngine.PostEvent("Machine_2", gameObject);
    ...
    void Update()
    {
        ...
        AkSoundEngine.SetRTPCValue("Machine_Movement_2", physicsMover.GetState().Velocity.magnitude);
    }
